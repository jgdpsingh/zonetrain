...
<button onclick="window.toggleCalendar(event)" class="btn-secondary">
  View Full Calendar
    ...
    // ... (existing methods like renderRacePlanningWidget)
    ...
    renderSubscriptionControls(containerId) {
        ...
        container.innerHTML = `
            ...
            <div style="padding: 20px; display: flex; flex-direction: column; gap: 12px;">
                <button onclick="window.dashboardWidgets.openPauseModal()" style="padding: 12px; border: 1px solid #d1d5db; background:white; border-radius: 8px; font-weight: 600; cursor:pointer;">⏸️ Pause Plan</button>
                <button onclick="window.dashboardWidgets.openDowngradeModal()" style="padding: 12px; border: 1px solid #fecaca; background:white; border-radius: 8px; font-weight: 600; color: #dc2626; cursor:pointer;">🔻 Downgrade</button>
            </div>
        `;
    }
    ...
    openPauseModal() {
        ...
        if(modal) {
             document.getElementById('pm-title').innerText = "Pause Plan";
             document.getElementById('pm-content').innerHTML = "<p>Pause training for 7-30 days?</p>";
    ...
    openDowngradeModal() {
         const modal = document.getElementById('planManagementModal');
         if(modal) {
             document.getElementById('pm-title').innerText = "Downgrade";
             document.getElementById('pm-content').innerHTML = "<p>Switch to Basic? Unused days will be refunded.</p>";
             modal.style.display = 'flex';
         }
    }
